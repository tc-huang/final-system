...
//           <Meta
//             title={person_name}
//             description={"圖片來源：" + data["daily_image_url"][0]}
//           />
//         </Card>
//       </Col>
//       <Col flex={1}>
...
//         <Title level={2}>
//           所屬政黨：{data["party"] != "TODO" && data["party"]}
//         </Title>
//         <Title level={2}>
//           職稱：{data["title"] != "TODO" && data["title"]}
//         </Title>
//         <p>備註：</p>
//         <p>
//           如果「所屬政黨」、「職稱」未顯示，因為 Google
//           搜尋無直接顯示資料。12345 為示意數值
//         </p>
//       </Col>
//       <Col flex={4}>
...
//                                       <Collapse ghost>
//                                         <Panel
//                                           header={value.opinion_list.join(" ")}
//                                         >
...
//     let response_array = [];
//     let end_point =
//       "https://g60lj6ls7h.execute-api.us-east-1.amazonaws.com/Prod";
//     let post_url = "";

//     if (
//       show_type === "timeline_all" ||
//       show_type === "timeline_today" ||
//       show_type === "timeline_yesterday" ||
//       show_type === "timeline_before_yesterday"
//     ) {
...
//                 temp["paragraph_vertex"] = gMapToObject(
//                   temp["paragraph_vertex"]
//                 );
...
//     //         }
//     else if (
//       show_type === "common_person_cluster_all" ||
//       show_type === "common_person_cluster_today" ||
//       show_type === "common_person_cluster_yesterday" ||
//       show_type === "common_person_cluster_before_yesterday"
//     ) {
//       let target_date = date;
...
//                 post_url =
//                   end_point +
//                   `/groupby-common-person?date=${"all"}&min_group_num=${min_group_num}`;
//               else
//                 post_url =
//                   end_point +
//                   `/groupby-common-person?date=${target_date}&min_group_num=${min_group_num}`;
//               fetch(post_url, { method: "POST" })
//                 .then((response) => response.json())
//                 .then((data) => {
//                   connected_components = data["connected_components"];
